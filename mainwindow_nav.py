...
class Ui_mainwindow_navigation(object):
    def setupUi(self, mainwindow_nav):
        mainwindow_nav.setObjectName("mainwindow_navigation")
        mainwindow_nav.resize(787, 582)
        self.centralwidget_allwindow_nav = QtWidgets.QWidget(mainwindow_nav)
        ...
        self.vl_allwindow_navi.addItem(spacerItem4)
        ...
        self.scrollareacontentwidgets_hl_bottom_navi.setGeometry(QtCore.QRect(0, -147, 233, 566))
        ...
        self.checkbox_enabletimefilter_navi = QtWidgets.QCheckBox(self.scrollareacontentwidgets_hl_bottom_navi)
        self.checkbox_enabletimefilter_navi.setObjectName("checkbox_enabletimefilter_navi")
        self.vl_timefilter_navi.addWidget(self.checkbox_enabletimefilter_navi)
        ...
        self.checkbox_vector01_navi = QtWidgets.QCheckBox(self.scrollareacontentwidgets_hl_bottom_navi)
        self.checkbox_vector01_navi.setObjectName("checkbox_vector01_navi")
        self.vl_vectorsfilter_navi.addWidget(self.checkbox_vector01_navi)
        self.checkbox_vector02_navi = QtWidgets.QCheckBox(self.scrollareacontentwidgets_hl_bottom_navi)
        self.checkbox_vector02_navi.setObjectName("checkbox_vector02_navi")
        self.vl_vectorsfilter_navi.addWidget(self.checkbox_vector02_navi)
        self.checkbox_vector03_navi = QtWidgets.QCheckBox(self.scrollareacontentwidgets_hl_bottom_navi)
        self.checkbox_vector03_navi.setObjectName("checkbox_vector03_navi")
        self.vl_vectorsfilter_navi.addWidget(self.checkbox_vector03_navi)
        ...
        self.hl_bottom_navi.addItem(spacerItem5)
        ...
        self.tablewidget_navi.horizontalHeader().setVisible(False)
        ...
        self.tablewidget_navi.horizontalHeader().setSortIndicatorShown(False)
        ...
        self.tablewidget_navi.verticalHeader().setStretchLastSection(False)
        ...
        mainwindow_nav.setCentralWidget(self.centralwidget_allwindow_nav)
        self.menubar = QtWidgets.QMenuBar(mainwindow_nav)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 787, 22))
        self.menubar.setObjectName("menubar")
        mainwindow_nav.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(mainwindow_nav)
        self.statusbar.setObjectName("statusbar")
        mainwindow_nav.setStatusBar(self.statusbar)

        self.retranslateUi(mainwindow_nav)
        QtCore.QMetaObject.connectSlotsByName(mainwindow_nav)
        self.button_setup()

    def button_setup(self):
        self.button_undo_navi.setCheckable(True)
        self.button_undo_navi.clicked.connect(self.button_undo_navi_clicked)
        self.button_redo_navi.setCheckable(True)
        self.button_redo_navi.clicked.connect(self.button_redo_navi_clicked)

        self.button_push_navi.setCheckable(True)
        self.button_push_navi.clicked.connect(self.button_push_navi_clicked)
        self.button_pull_navi.setCheckable(True)
        self.button_pull_navi.clicked.connect(self.button_pull_navi_clicked)
        self.button_vectortableview_navi.setCheckable(True)
        self.button_vectortableview_navi.clicked.connect(self.button_vectortableview_navi_clicked)
    ...
    def retranslateUi(self, mainwindow_navigation):
        ...
        self.checkbox_enabletimefilter_navi.setText(_translate("mainwindow_navigation", "Enable Time Filter"))
        ...
        self.checkbox_vector01_navi.setText(_translate("mainwindow_navigation", "Vector01"))
        self.checkbox_vector02_navi.setText(_translate("mainwindow_navigation", "Vector02"))
        self.checkbox_vector03_navi.setText(_translate("mainwindow_navigation", "Vector03"))
    ...
    def button_undo_navi_clicked(self):
        print(self.button_undo_navi.text())
        self.button_undo_navi.toggle()

    def button_redo_navi_clicked(self):
        print(self.button_redo_navi.text())
        self.button_redo_navi.toggle()

    def button_push_navi_clicked(self):
        print(self.button_push_navi.text())
        self.button_push_navi.toggle()

    def button_pull_navi_clicked(self):
        print(self.button_pull_navi.text())
        self.button_pull_navi.toggle()
