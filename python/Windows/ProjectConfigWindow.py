...
class ProjectConfigWindow(QMainWindow):
    def __init__(self):
        ...
        self.rootpathledit = QLineEdit('Root path goes here(Directory containing all 3 teams folder).')
        ...
        path1label = QLabel('Directory path red team:')
        self.path1ledit = QLineEdit('Directory path of red team goes here.')
        ...
        path2label = QLabel('Directory path blue team:')
        self.path2ledit = QLineEdit('Directory path of blue team goes here.')
        ...
        path3label = QLabel('Directory path white team:')
        self.path3ledit = QLineEdit('Directory path of white team goes here.')
